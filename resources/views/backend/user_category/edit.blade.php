                        ...
                        <div class="card-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    ...
                                    <label class="form-label" for="title">User Category<b class="text-danger">*</b> </label>
                                        <input type="text" id="title" name="category_name" class="form-control" placeholder="Category Name" value="{{ $userCategory->name }}" required>
                                        @error('category_name')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="off_percentage" name="off_percentage" class="form-control" placeholder="Off Percentage" value="{{ $userCategory->off_percentage }}" required>
