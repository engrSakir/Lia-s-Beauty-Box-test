...
@section('content')
    ...
    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="<?php echo asset('/').'uploads/'.$user->img_name;?>" class="img-circle" width="150" />
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                          ...
                          <img id="blah" width="250px" src="<?php echo asset('/').'uploads/'.$user->img_name;?>" alt="your image" />
