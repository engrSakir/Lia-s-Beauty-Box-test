...
@section('title') Image Category @endsection
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header bg-info">
                    <h4 class="mb-0 text-white">Create Image Category</h4>
                </div>
                <div class="card-body">
                <form action="{{ route('backend.imageCategory.store') }}" method="POST" class="form-horizontal form-material" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="card-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="category_name">Image Category<b class="text-danger">*</b> </label>
