    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('backend.user.create', 'role=Employee') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create
                    New</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <button  class="btn btn-danger btn-circle delete-btn" value="{{ route('backend.user.show', $employee) }}">
