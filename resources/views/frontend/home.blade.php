            ...
            <div class="tab-content">
                                            ...
                                            <div class="col-md-6">
                                                <div class="wt-tilte">
                                                    ...
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                        ...
                                                        theLorem Ipsum is simply dummy
                                                        text of the printing and eentially unchanged.
                                                    </p>
                                                    <a href="#" class="site-button skew-icon-btn radius-sm">
                                                        <span
                                                            class="font-weight-700 inline-block text-uppercase p-lr15">More</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div id="pricing-item4" class="pricing-tab-content-block tab-pane">
                    <div class="section-content p-t50">
                        ...
                        <div class="wt-tabs vertical bg-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#pricing-tab4-1">Hand-On Facial </a>
                                </li>
                ...
                <div id="pricing-item6" class="pricing-tab-content-block tab-pane ">
                    <div class="section-content p-t50">
                        ...
                        <div class="wt-tabs vertical bg-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#pricing-tab6-1">Massage Therapy</a>
                                </li>
                ...
                <div class="owl-carousel home-carousel-1">
                        ...
                        <div class="testimonial-5 bg-white radius-sm">
                            <div class="testimonial-pic-block radius-bx">
                                <div class="testimonial-pic radius">
                                    <img src="/assets/frontend/images/testimonials/pic1.jpg" width="132" height="132"
                                        alt="">
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class=" testimonial-5 bg-white radius-sm">
                            <div class="testimonial-pic-block radius-bx">
                                <div class="testimonial-pic radius">
                                    <img src="/assets/frontend/images/testimonials/pic2.jpg" width="132" height="132"
                                        alt="">
                                </div>
                            </div>
                            <div class="testimonial-text clearfix">
