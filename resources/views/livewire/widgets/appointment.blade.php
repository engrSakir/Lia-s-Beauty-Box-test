                    ...
                    <div class="list-group">
                        @foreach ($schedules['data_set'] as $key => $schedule)
                            <a href="javascript:void(0)"
                                wire:click="select_schedule('{{ $schedule->id }}')"
                ...
                <div class="card-body">
                    <form wire:submit.prevent="store">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <input wire:model="transaction_id" type="text" class="form-control"
                                    id="transaction_id" placeholder="Transaction Id">
                            </div>
                            <div class="form-group col-md-4">
                                <input wire:model="advance_amount" type="text" class="form-control"
                                    id="advance_amount" placeholder="Advance Amount">
                            </div>
                            <div class="form-group col-md-4">
                                <select class="form-control">
                                    <option value="" wire:model="services">Please Choose A Service
                                    </option>
                                </select>
                            </div>
                        </div>
